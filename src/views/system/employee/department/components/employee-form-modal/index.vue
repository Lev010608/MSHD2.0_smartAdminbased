...
<template>
  ...
  >
    <a-form ref="formRef" :model="form" :rules="rules" layout="vertical">
      <a-form-item label="城市" name="actualName">
        <a-input v-model:value.trim="form.actualName" placeholder="请输入所在城市" />
      </a-form-item>
...
import { smartSentry } from '/@/lib/smart-sentry';
  ...
  const rules = {
    actualName: [
      { required: true, message: '城市名不能为空' },
      { max: 30, message: '城市名不能大于30个字符', trigger: 'blur' },
    ],
    phone: [
